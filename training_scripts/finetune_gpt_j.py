...
DATA_PATH = "alpaca-data-clean-v2/"
BLOCK_SIZE = 1024
...
EPOCHS = 3
LEARNING_RATE = 3e-4
OUTPUT_DIR = "gpt_j_results"
TRAIN_ON_INPUT = False
TEST_SIZE = 0.1
EVAL_SAMPLES = 3

SINGLE_TEXTS = False  # with single texts, we pass a single data point for each time step
if SINGLE_TEXTS:
    BLOCK_SIZE = 512
...
def print_trainable_parameters(model):
    ...
    print(
        f"trainable parameters: {trainable_params} | all parameters: {all_param} | percent of trainable parameters: {100 * trainable_params / all_param}"
    )
...
trainer = transformers.Trainer(
    ...
    callbacks=[SampleCallback],  # remove callback for speed increase
)
